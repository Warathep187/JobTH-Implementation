...
const CompanyLoginForm = ({ onLoginHandler, enteredData, onSetEnteredData, loading }) => {
    ...
    <Box>
      <FormContainer>
        ...
        <ForgotPasswordContainer>
          <StyledLink href="/auth/companies/forgot-password" isforgotpasswordlink>
            ลืมรหัสผ่าน?
          </StyledLink>
        </ForgotPasswordContainer>
        ...
        <UnregisteredContainer>
          <span>ยังไม่ได้เป็นสมาชิก JobTH?</span> <StyledLink href="/auth/companies/create">สมัครสมาชิก</StyledLink>
        </UnregisteredContainer>
      </FormContainer>
    </Box>
  );
